...
const m_and_b = ["Online onsite admission test Radio Navigation v23.1.json", "Online onsite admission test Radio Navigation v23.2.json", "Online onsite admission test Radio Navigation v23.3.json", "Online onsite admission test Radio Navigation v23.4.json", "Online onsite admission test Radio Navigation v24.1.json", "Online onsite admission test Radio Navigation v24.2.json", "Online onsite admission test Radio Navigation v24.3.json"]

m_and_b.forEach((filename) => populateQuestions(filename))

function populateQuestions(filename) 
{
    fetch(`jsons/RadNav/${filename}`)
    .then(res => res.json())
    .then(data => {
